          ...
          <div className="container clearfix">
            ...
            <div className="right">
                <div className="top">
                    <aside id="aside" className="clearfix">
                        <ul>
                            ...
                            <li>
                                <form name="search-form" id ="search-form" method="post" action="./search.html">
                                    <div>
                                       ...
                                       <div>                                        
                                        ...
                                        <a href="#!" className="search-btn">
                                           <img src="./img/icon_magnifier_black.png" alt="돋보기"/>
                                        </a>
                                    </div>
                                </form>
                            </li>
                ...
                <div className="mobile">
                    <ul>
                        <li><a href="#!" className="login-btn"><img src="./img/뉴스타벅스/icon_user_m.png" alt="로그인"/></a></li>
                        <li><a href="#!" className="map-btn"><img src="./img/뉴스타벅스/icon_spot_m.png" alt="맵"/></a></li>
                        <li><a href="#!" className="berger-btn"><img src="./img/뉴스타벅스/btn_berger_m.png" alt="메뉴"/></a></li>
                    </ul>
                </div>
            </div>
